...
#define DUAL_FUNC_2 LT(5, KC_F10)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_ENTER,       KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_ENTER,
                                                    LT(1, KC_SPACE), LT(3, QK_REPEAT_KEY),                                          LT(4, QK_REPEAT_KEY),          LT(2, KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
...
const uint16_t PROGMEM combo1[] = { MO(3), MO(4), COMBO_END};
const uint16_t PROGMEM combo2[] = { KC_MS_BTN2, RGUI(KC_MINUS), COMBO_END};
